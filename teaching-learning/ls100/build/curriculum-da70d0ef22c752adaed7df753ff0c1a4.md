...
description: The weekly schedule for enrolled LS100 students.
---

This page is for students enrolled in LS100. It maps the modules onto the weekly meeting schedule. Self-paced learners can follow the same content through [Start Here](start-here.md).

:::{note}
The weekly schedule is finalized each semester. Enrolled students should follow the dates posted on the course's Canvas site; the modules here are ordered to match that schedule.
:::
...
|---|---|---|---|
| **00** | Draft research proposal and form research team. Frame research questions, why they matter, hypotheses, the test / experimental approach, and expected outcome. | Research Guide 00: Converting the Problem to a Research Framework. | Project Proposal (200–300 words). |
| **01** | Work Plan in storytelling format: Background → Hypothesis → Experiment Design → Tool Design (optional) → Data Collection → Data Analysis → Results → Report. | Research Guide 01: Presenting Research Plans and Proposals; Computation Guide 01: Getting Started with Python. Lab — Notebook 01: Introduction to Python Programming (Data in Python). | **Presentation 01** — Work Plan. |
...
| **05** | Data processing: data collection and labeling; create a tertiary dataset — e.g. feature clusters / segments, or kinematics (velocity / angles / counts). | Research Guide 02: Writing Research Plans and Proposals; Art of Communicating Science. | Notebook: converting secondary → tertiary datasets; first draft of the project report. |
