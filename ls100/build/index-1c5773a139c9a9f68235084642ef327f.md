...
Every notebook can be run three ways — see [How to run](how-to-run.md) for details.

::::{grid} 1 1 3 3

:::{card} 💻 Download & run locally
Best if you want to work offline on your own machine.
:::

:::{card} ☁️ Open in Google Colab
Best for a zero-install browser session with a free GPU.
:::

:::{card} 🧰 GitHub Codespaces
...
Licensed **CC BY-NC 4.0** · [How to cite](about.md) ·
[GitHub](https://github.com/Souvik-Mandal-Harvard/Computational-Behavioral-Sciences_LS100_Harvard) ·
